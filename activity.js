...
addBook = (title, author) => {bookList.push({title, author});}

addBook("Horton Hears a Who", "Dr. Seuss");
console.log(bookList)

console.log(bookList.findIndex(i => i.title == "Horton Hears a Who" && i.author == "Dr. Seuss"));
console.log(bookList.indexOf({title: "Horton Hears a Who", author: "Dr. Seuss"}));
const removeBook = (title, author) => {bookList.pop({title, author});}

removeBook("test", "test");
removeBook("Horton Hears a Who", "Dr. Seuss");
console.log(bookList);
